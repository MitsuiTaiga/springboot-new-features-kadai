...
public class ReviewController {
    ...
    @GetMapping("/{houseId}/index")
	public String review(@PathVariable(name = "houseId") Integer id, Model model, @PageableDefault(page = 0, size = 10, sort = "createdAt") Pageable pageable) {
    ...
    {    
       ...
       reviewService.create(house, user, reviewRegisterForm);
        ...
        return "redirect:/review/{houseId}/index";
    }     
    ...
    @PostMapping("/{houseId}/reviews/{reviewId}/delete")
